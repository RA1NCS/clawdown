...
import { uploadPdf, EXPIRY_SECONDS } from '../storage';
...
const SERVER_INSTRUCTIONS = [
    ...
    'The response contains a download_url valid for 15 minutes, a page_count, and file_size_kb.',
...
function createServer() {
    ...
    server.registerTool(
        ...
        async ({ markdown, clawds = true }) => {
            ...
            const downloadUrl = await uploadPdf(key, finalPdf);
